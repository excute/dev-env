...
New-Item -Path "$env:OneDrive/Documents/PowerShell/Microsoft.PowerShell_profile.ps1" -ItemType HardLink -Value "./Microsoft.PowerShell_profile.ps1"
# New-Item -Path "$env:OneDrive/Documents/PowerShell/Microsoft.PowerShell_profile.ps1" -ItemType SymbolicLink -Target "./Microsoft.PowerShell_profile.ps1"
...
# New-Item -Path "$env:OneDrive/Documents/PowerShell/oh-my-posh.json" -ItemType SymbolicLink -Target "../oh-my-posh/oh-my-posh.json"
